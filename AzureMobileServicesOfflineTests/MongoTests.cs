...
namespace AzureMobileServicesOfflineTests
{
    public class MongoTests : TestBase
    {
        ...
        public void Mongo_PullAsync_Incremental_Throws()
        {
            ...
            Assert.Equal("http://localhost:31475/tables/Mongo?$filter=(__updatedAt ge datetimeoffset'1970-01-01T00:00:00.0000000%2B00:00')&$orderby=__updatedAt&__includeDeleted=true&__systemproperties=__createdAt%2C__updatedAt%2C__version%2C__deleted", ex.Request.RequestUri.ToString());
        }
